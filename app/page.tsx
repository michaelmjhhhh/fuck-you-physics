  ...
  return (
    <>
      ...
      <main className="app-shell pb-24">
        <section className="grid gap-8 py-14">
          <div className="grid gap-5">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="#syllabus"
                className="inline-flex min-h-[46px] items-center justify-center rounded-full bg-[linear-gradient(180deg,var(--terracotta)_0%,var(--terracotta-deep)_100%)] px-5 py-3 text-sm font-semibold text-[var(--ivory)] shadow-[0_10px_24px_rgba(201,100,66,0.22)] transition hover:-translate-y-0.5"
              >
                Browse syllabus
              </a>
              <a
                href="/practice/a4-rigid-body-mechanics"
                className="inline-flex min-h-[46px] items-center justify-center rounded-full border border-[var(--border-cream)] bg-[rgba(250,249,245,0.92)] px-5 py-3 text-sm font-semibold text-[var(--near-black)] shadow-[0_0_0_1px_rgba(232,230,220,0.55)] transition hover:-translate-y-0.5"
              >
                Open live practice
              </a>
            </div>
        ...
        <section id="syllabus" className="pb-24 pt-2">
