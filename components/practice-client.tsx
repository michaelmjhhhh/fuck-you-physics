...
function PracticeModeControls({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 overflow-x-auto scroll-smooth snap-x pb-2 [-ms-overflow-style:'none'] [scrollbar-width:'none'] [&::-webkit-scrollbar]:hidden">
      <button
        type="button"
        onClick={toggleZen}
